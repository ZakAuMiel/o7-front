    ...
    <div class="flex flex-col md:flex-row gap-12 p-8 w-full max-w-6xl">
      ...
      >
        ...
        <p class="mt-4 text-lg text-accent max-w-md">
          Bienvenue sur <strong>07</strong> – la plateforme où tes potes peuvent
          t'envoyer leurs mèmes en live. Authentifie-toi avec Discord et balance
          des clips, images ou gifs en temps réel sur le stream !
        </p>
      </div>
      ...
      <div class="flex-1 flex justify-center items-center">
        <div
          class="bg-panel border border-accent rounded-xl p-8 w-full max-w-md shadow-md"
        >
